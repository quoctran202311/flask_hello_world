...
CREATE TABLE IF NOT EXISTS Clients(
    ClientID INT NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS Produits(
    ProduitID INT NOT NULL PRIMARY KEY AUTOINCREMENT,
    created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    Nom TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Livreurs(
    LivreurID INT NOT NULL PRIMARY KEY AUTOINCREMENT,
    created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    Nom TEXT NOT NULL,
    Prenom TEXT NOT NULL,
    Telephone TEXT NOT NULL
...
CREATE TABLE IF NOT EXISTS Commandes(
    CommandeID INT NOT NULL PRIMARY KEY AUTOINCREMENT,
    created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS Detail_Commande(
    DetailID INT NOT NULL PRIMARY KEY AUTOINCREMENT,
    created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS Livraisons(
    LivraisonID INT NOT NULL PRIMARY KEY AUTOINCREMENT,
    created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
